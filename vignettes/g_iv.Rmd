...
description: >
  Instrumental Variables estimation in R with causalverse: recovering consistent causal estimates when unobserved confounders bias OLS.
author: "Mike Nguyen"
date: "`r Sys.Date()`"
...
```{r mr_comparison_table, eval=FALSE}
...
```{r mr_egger_intercept, eval=FALSE}
...
```{r late_complier_char, eval=FALSE}
