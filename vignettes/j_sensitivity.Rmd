...
description: >
  Sensitivity analysis and robustness checks in R with causalverse: probing the untestable assumptions behind matching, DiD, IV, RD, and synthetic control.
author: "Mike Nguyen"
date: "`r Sys.Date()`"
...
```{r, include = FALSE}
knitr::opts_chunk$set(collapse = TRUE, comment = "#>", cache = TRUE, error = TRUE)
```
...
```{r evalue-basic, eval=requireNamespace("EValue", quietly = TRUE), error=TRUE}
library(EValue)
...
```{r evalue-designs, eval=requireNamespace("EValue", quietly = TRUE), error=TRUE}
...
```{r evalue-plot, eval=requireNamespace("EValue", quietly = TRUE), error=TRUE}
# Bias plot
...
```{r manski-bounds-comparison, eval=TRUE, message=FALSE, warning=FALSE}
...
```{r sensemakr-contour-matched, eval=requireNamespace("sensemakr", quietly=TRUE) && requireNamespace("MatchIt", quietly=TRUE), message=FALSE, warning=FALSE}
...
```{r sensemakr-extreme-matched, eval=requireNamespace("sensemakr", quietly=TRUE) && requireNamespace("MatchIt", quietly=TRUE), message=FALSE, warning=FALSE}
