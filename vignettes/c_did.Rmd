...
```{r twfe-weights, eval=FALSE, error = TRUE}
...
```{r panelview-example, eval=FALSE}
library(panelView)
...
```{r staggered-example, eval=FALSE}
library(staggered)
...
```{r vis-te-dist, eval=FALSE, fig.width=8, fig.height=5}
...
```{r vis-parallel-trends, eval=FALSE, fig.width=9, fig.height=5.5}
...
```{r vis-counterfactual, eval=FALSE, fig.width=9, fig.height=5.5}
...
```{r mundlak-estimates, eval=FALSE}
...
```{r mundlak-plot, eval=FALSE, fig.width=8, fig.height=5}
...
```{r control-group-setup, eval=FALSE}
library(did)
...
```{r control-group-dynamic, eval=FALSE}
...
```{r control-group-plot, eval=FALSE, fig.width=9, fig.height=5.5}
...
```{r control-group-scatter, eval=FALSE, fig.width=7, fig.height=6}
...
```{r pipeline-love-plot, eval=FALSE, fig.width=8, fig.height=4}
...
```{r pipeline-pretrend-test, eval=FALSE}
...
```{r pipeline-main-estimates, eval=FALSE}
...
```{r pipeline-placebo, eval=FALSE, fig.width=8, fig.height=5}
set.seed(42)
n_placebo <- 300
...
```{r pipeline-log-robust, eval=FALSE}
...
```{r pipeline-coef-plot, eval=FALSE, fig.width=9, fig.height=6.5}
...
```{r pipeline-checklist, eval=FALSE}
...
```{r honest_did_eventstudy, eval=FALSE}
...
```{r honest_did_extract, eval=FALSE}
...
```{r honest_did_smooth, eval=FALSE}
...
```{r honest_did_smooth_plot, eval=FALSE, fig.width=9, fig.height=5}
...
```{r honest_did_breakdown, eval=FALSE}
...
```{r honest_did_rm_plot, eval=FALSE, fig.width=9, fig.height=5}
...
```{r cs_honest_integration, eval=FALSE}
library(did)
...
```{r stacked_did_eventstudy, eval=FALSE}
...
```{r stacked_did_hdd_robust, eval=FALSE}
