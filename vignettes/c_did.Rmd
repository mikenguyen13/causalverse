...
comparison_tbl <- data.frame(
  ...
  Estimate     = c(true_att,
                   round(twfe_est, 4),
                   round(coef(sunab_att)["ATT"], 4)),
  Bias         = c(0,
                   round(twfe_est - true_att, 4),
                   round(coef(sunab_att)["ATT"] - true_att, 4)),
  Notes = c(
    "Population truth",
...
```{r twfe-weights, eval=requireNamespace("TwoWayFEWeights", quietly = TRUE)}
