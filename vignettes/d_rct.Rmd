...
```{r ri2-blocked, eval = requireNamespace("ri2", quietly = TRUE) && requireNamespace("randomizr", quietly = TRUE)}
...
```{r consort-diagram, eval = TRUE, fig.width = 10, fig.height = 8}
...
```{r ancova-monte-carlo, eval = TRUE, fig.width = 9, fig.height = 5}
