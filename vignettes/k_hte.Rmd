...
```{r metalearner-compare, eval=FALSE, fig.width=8, fig.height=5}
...
```{r grf-varimp, eval=FALSE, fig.width=7, fig.height=4}
...
```{r grf-cate-dist, eval=FALSE, fig.width=7, fig.height=4}
cate_df <- data.frame(
  tau_cf   = tau_cf,
  tau_true = tau_true,
  tau_se   = tau_se
...
```{r grf-scatter, eval=FALSE, fig.width=6, fig.height=5}
...
```{r grf-summary-plots, eval=FALSE, fig.width=7, fig.height=4}
cf_summary$plot_cate_dist
```

```{r grf-importance-plot, eval=FALSE, fig.width=7, fig.height=4}
...
```{r blp-plot, eval=FALSE, fig.width=6, fig.height=4}
blp_res$blp_plot
```
...
```{r gates-plot, eval=FALSE, fig.width=7, fig.height=4}
blp_res$gates_plot
```
...
```{r qini-plot, eval=FALSE, fig.width=7, fig.height=4}
qini_res$plot +
...
```{r qini-compare, eval=FALSE, fig.width=8, fig.height=5}
...
```{r forest-plot, eval=FALSE, fig.width=7, fig.height=5}
...
```{r scatter-plot, eval=FALSE, fig.width=7, fig.height=4}
...
```{r violin-plot, eval=FALSE, fig.width=7, fig.height=4}
...
```{r pdp-plot, eval=FALSE, fig.width=7, fig.height=4}
...
```{r calibration-plot, eval=FALSE, fig.width=7, fig.height=4}
...
```{r dml-heterogeneous, eval=FALSE}
...
```{r doubleml, eval=FALSE && requireNamespace("mlr3learners", quietly=TRUE), error=TRUE}
library(DoubleML)
library(mlr3)
...
```{r subgroup-forest, eval=FALSE, fig.width=8, fig.height=5}
...
```{r cf-ci, eval=FALSE, fig.width=7, fig.height=4}
...
```{r pipeline-bootstrap, eval=FALSE}
set.seed(42)
B_pipe <- 100
...
```{r pub-forest, eval=FALSE, fig.width=8, fig.height=6}
...
```{r feature-importance-pub, eval=FALSE, fig.width=7, fig.height=4}
...
```{r cate-summary-fig, eval=FALSE, fig.width=8, fig.height=4}
...
```{r stochastic-policy, eval=FALSE}
...
```{r continuous-treatment, eval=FALSE}
...
```{r full-pipeline-plots, eval=FALSE, fig.width=8, fig.height=4}
# Step 5: Visualize
pipeline_summary$plot_cate_dist
```

```{r full-pipeline-gates, eval=FALSE, fig.width=8, fig.height=4}
pipeline_summary$plot_gates
```

```{r full-pipeline-qini, eval=FALSE}
...
```{r integrated-workflow, eval=FALSE}
...
```{r lalonde-forest-plot, eval=FALSE, fig.width=8, fig.height=5}
...
```{r lalonde-qini, eval=FALSE, fig.width=7, fig.height=4}
# Qini for Lalonde
