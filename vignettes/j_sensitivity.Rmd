...
```{r, include = FALSE}
knitr::opts_chunk$set(collapse = TRUE, comment = "#>", cache = TRUE, eval = FALSE)
```
...
```{r sensemakr-contour, eval=FALSE}
...
```{r sensemakr-extreme, eval=FALSE}
...
```{r sensemakr-multiple, eval=FALSE}
...
```{r rosenbaum-sensitivitymv, eval=FALSE}
...
```{r evalue-basic, eval=FALSE, error=TRUE}
library(EValue)
...
```{r evalue-designs, eval=FALSE, error=TRUE}
...
```{r evalue-plot, eval=FALSE, error=TRUE}
# Bias plot
...
```{r spec-curve-plot, eval=FALSE, fig.width=7, fig.height=6}
...
```{r spec-curve-indicators, eval=FALSE, fig.width=7, fig.height=4}
...
```{r multiple-testing-fwer, eval=FALSE}
...
```{r multiple-testing-fdr, eval=FALSE}
...
```{r ri-plot, eval=FALSE, fig.width=6, fig.height=4}
# Visualization
...
```{r bootstrap-cluster, eval=FALSE}
set.seed(202)
n_clusters <- 30
cluster_size <- 20
...
```{r wild-bootstrap-few, eval=FALSE}
...
```{r konfound-setup, eval=FALSE, message=FALSE, warning=FALSE}
library(konfound)
...
```{r konfound-model, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r pkonfound-published, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r konfound-itcv, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r treatsens-setup, eval=FALSE, message=FALSE, warning=FALSE}
library(treatSens)
...
```{r treatsens-analysis, eval=FALSE, message=FALSE, warning=FALSE, fig.width=7, fig.height=5}
...
```{r tipr-setup, eval=FALSE, message=FALSE, warning=FALSE}
library(tipr)
...
```{r tipr-tip, eval=FALSE, message=FALSE, warning=FALSE}
# What unmeasured confounder would tip the coefficient to zero?
tip_result <- tip_coef(effect = est, se = se_est)
tip_result
```

```{r tipr-adjust, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r ovtool-setup, eval=FALSE, message=FALSE, warning=FALSE}
library(OVtool)
library(twang)
...
```{r ovtool-sim, eval=FALSE, message=FALSE, warning=FALSE, fig.width=7, fig.height=5}
...
```{r causalsens-setup, eval=FALSE, message=FALSE, warning=FALSE}
library(causalsens)
...
```{r causalsens-analysis, eval=FALSE, message=FALSE, warning=FALSE, fig.width=7, fig.height=5}
...
```{r causalsens-aligned, eval=FALSE, message=FALSE, warning=FALSE, fig.width=7, fig.height=5}
...
```{r sens-contour-setup, eval=FALSE, message=FALSE, warning=FALSE}
set.seed(42)
n_s <- 800
x1  <- rnorm(n_s)
x2  <- rnorm(n_s)
...
```{r sens-contour-plot, eval=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=6}
...
```{r evalue-multi, eval=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=5}
...
```{r spec-curve-vis, eval=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=7}
...
```{r breakdown-plot, eval=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=5}
...
```{r sens-calibration, eval=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=5}
...
```{r manski-bounds-comparison, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r mtr-bounds, eval=FALSE, message=FALSE, warning=FALSE}
# Under MTR (Y(1) >= Y(0)):
...
```{r mts-bounds, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r bounds-comparison-plot, eval=FALSE, message=FALSE, warning=FALSE, fig.width=9, fig.height=5}
...
```{r qte-setup, eval=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=5}
...
```{r stochastic-dominance, eval=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=5}
...
```{r te-distribution, eval=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=5}
...
```{r rosenbaum-setup, eval=FALSE, message=FALSE, warning=FALSE}
library(MatchIt)
...
```{r rosenbaum-gamma, eval=FALSE, message=FALSE, warning=FALSE}
library(rbounds)
...
```{r rosenbaum-gamma-plot, eval=FALSE, message=FALSE, warning=FALSE, fig.width=9, fig.height=5}
...
```{r gamma-threshold, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r sensemakr-demo, eval=FALSE, message=FALSE, warning=FALSE}
library(sensemakr)
data("lalonde", package = "MatchIt")
...
```{r sensemakr-contour-matched, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r sensemakr-stats, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r sensemakr-extreme-matched, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r sensemakr-benchmark-table, eval=FALSE, message=FALSE, warning=FALSE}
