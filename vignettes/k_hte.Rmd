...
description: >
  Heterogeneous treatment effects and causal machine learning in R with causalverse: looking past the average treatment effect to see who responds.
author: "Mike Nguyen"
date: "`r Sys.Date()`"
...
```{r policy-value-plot, eval=FALSE, fig.width=7, fig.height=4}
