...
description: >
  Panel data methods in R with causalverse: estimation, diagnostics, and inference for units observed across multiple time periods.
author: "Mike Nguyen"
date: "`r Sys.Date()`"
...
```{r variance-decomp-plot, eval=FALSE, fig.width=6, fig.height=4}
vd_vars <- c("y", "x1", "x2")
