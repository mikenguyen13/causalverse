...
description: >
  Difference-in-Differences in R with causalverse: setting up panel data, estimating treatment effects, and checking the design assumptions.
author: "Mike Nguyen"
date: "`r Sys.Date()`"
...
```{r vis-eventstudy-bonf, eval=FALSE, fig.width=9, fig.height=5.5}
...
```{r vis-cohort-atts, eval=FALSE, fig.width=9, fig.height=6}
library(did)
